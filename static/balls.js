...
function Initialize(containerId) {
    ...
    balls.push(new Ball(svg, Math.random()*width, Math.random()*height, 'n1', 'DimGray', Math.PI / Math.random()*3,50, "maxogryzko.com/static/Max_Ogryzko_Resume.pdf","https://cdn2.iconfinder.com/data/icons/project-management-16/48/30-512.png"));
